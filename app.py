    ...
    return html.Div(
        ...
        children=[
            html.Div(
                id="banner-text",
                children=[
                    html.H5("THD - The Health Dashboard"),
                    html.H6("View the Health of your drivers and commodities here."),
                ],
            ),
            html.Div(
                id="banner-logo",
                children=[
                    ...
                    html.Img(id="logo", src=app.get_asset_url("bino1.png")),
                ],
            ),
        ],
    )
            ...
            dcc.Tabs(
                ...
                children=[
                    ...
                    dcc.Tab(
                        ...
                        label="Your Driver and Commodity Health Dashboard",
                        value="tab2",
                        className="custom-tab",
                        selected_className="custom-tab--selected",
                    ),
            ...
            html.Div(
                ...
                children=[
                    ...
                    html.Div(
                        ...
                        This is a dashboard for monitoring real-time overview of your driver health and commodity health in journey. 
                        ###### What does this app shows?
                        See the following information in your dashboard:
                        * HUMIDITY - Humidity of your commodities in the truck
                        * TEMPERATURE - Temperature of your commodities in the truck
                        * SHOCK - Shock or vibration rate of your commodities in the truck
                        * SMOKE - Smoke rate of your commodities in the truck
                        * BLIK_RATE - Blink Rate of your driver
                        * SPEED - Speed of the truck
                        * PROXIMITY - Proximity of your truck with other trucks

                        You can also view the driver location, id, information. 
                    """
                            )
                        ),
                    ),
    ...
    return html.Div(
        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    generate_section_banner("Health Metrics Summary"),
                    html.Div(
                        id="metric-div",
                        children=[
...
def generate_metric_list_header():
    return generate_metric_row(
        ...
        {"id": "m_header_3", "children": html.Div("Trend")},
    ...
    return generate_metric_row(
        ...
        None,
        {
            ...
            "children": html.Button(
                ...
                children=item,
                title="Click to visualize live THD chart",
                n_clicks=0,
            ),
        },
...
def build_chart_panel():
    return html.Div(
        ...
        className="twelve columns",
        children=[
            generate_section_banner("Live Health Chart"),
            dcc.Graph(
